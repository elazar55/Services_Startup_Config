...
' COPYRIGHT   : © 2016-2022 Ramesh Srinivasan
...
Else
   ...
   Dim sStartState, sSvcName, sSkippedSvc, sSvcStatus
   ...
   For Each objService In colListOfServices
      ...
      ' Dim padding_length
      ' padding_length = 80 - LEN(sSvcName) - 7
      ' b.WriteBlankLines 1
      ' b.Write "@REM " & sSvcName & " "
      ' Dim i
      ' For i = 0 To padding_length
      '    b.Write "="
      ' Next
      ' b.WriteBlankLines 1
      ...
      Select Case sSvcStatus
         Case "Stopped"
         b.WriteLine "sc.exe stop " & sSvcName
      End Select
